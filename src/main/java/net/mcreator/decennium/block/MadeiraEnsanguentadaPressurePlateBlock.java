...
package net.mcreator.decennium.block;
...
public class MadeiraEnsanguentadaPressurePlateBlock extends PressurePlateBlock {
	public MadeiraEnsanguentadaPressurePlateBlock() {
